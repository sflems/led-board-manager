# Generated by Django 3.1.3 on 2021-05-23 03:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supervisorName', models.CharField(max_length=32, unique=True)),
                ('pythonVersion', models.IntegerField(choices=[(2, 'Two'), (3, 'Three')], default=3)),
            ],
            options={
                'verbose_name': 'Board',
